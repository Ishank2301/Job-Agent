...
export function GoogleButton({ disabled = false }: { disabled?: boolean }) {
  ...
  return (
    <button
      ...
      className="btn btn-google w-full justify-center gap-3 disabled:cursor-not-allowed disabled:opacity-50"
    >
      {pending ? (
...
export function GitHubButton({ disabled = false }: { disabled?: boolean }) {
  const [pending, setPending] = useState(false);
  ...
  return (
    <button
      ...
      className="btn btn-github w-full justify-center gap-3 disabled:cursor-not-allowed disabled:opacity-50"
    >
      {pending ? (

        ...
        <table className="w-full text-left text-sm">
          <tbody>
            {ENDPOINTS.map(([method, path, desc]) => (
              <tr key={method + path} className="border-b border-line last:border-0 hover:bg-surface-2">
                ...
                <td className="px-4 py-3 font-mono text-xs text-ink-soft">{path}</td>
                <td className="px-6 py-3 text-xs text-muted">{desc}</td>
              </tr>
            ))}
          </tbody>
        </table>
